...
public enum CompletionsHandler {
    ...
    private static func coreImagePart(_ value: String) throws -> SwamaCore.ContentPart {
        // Validation lives in ImageInputParser so Chat and Responses share one
        // implementation; see that type for the rules.
        guard let part = ImageInputParser.contentPart(value) else {
