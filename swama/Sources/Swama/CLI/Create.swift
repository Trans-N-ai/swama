...
struct Create: AsyncParsableCommand {
    static let configuration: CommandConfiguration = .init(
        abstract: "Create a model entry from a user-specified path and name. The model metadata (.swama-meta.json) will be saved to ~/.swama/models/local/<name>, allowing the model to be run later using this name."
    )
